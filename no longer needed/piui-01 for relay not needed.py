...
class relay_test(object):
	...
	def page_toggles(self):
		...
		self.list.add_item("Relay 1", chevron=False, toggle=True, ontoggle=functools.partial(self.ontoggle, "Relay 1"))
		self.list.add_item("Relay 2", chevron=False, toggle=True, ontoggle=functools.partial(self.ontoggle, "Relay 2"))
		self.list.add_item("Relay 3", chevron=False, toggle=True, ontoggle=functools.partial(self.ontoggle, "Relay 3"))
		
		self.page.add_element("hr")
		self.title = self.page.add_textbox("Relay Board Test", "h1")
